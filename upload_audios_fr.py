...
BUCKET_NAME = "audios"
PASTA_LOCAL = "audios_dingli/fr"

if SUPABASE_SERVICE_KEY == "SUA_SERVICE_ROLE_AQUI":
    print("\n[ERRO] Passe a service_role como argumento:\npython upload_audios_fr.py SUA_CHAVE\n")
    sys.exit(1)

UPLOAD_URL = f"{SUPABASE_URL}/storage/v1/object/{BUCKET_NAME}/fr"
...
def main():
    ...
    total = len(arquivos)
    print(f"Iniciando envio nativo de {total} arquivos para {BUCKET_NAME}/fr/...")
