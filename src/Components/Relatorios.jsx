                ...
                <div style={{ ...styles.cardFixoRelativo, flex: 1, backgroundColor: ns.bg, padding: '14px', display: 'flex', flexDirection: 'column', marginBottom: '15px', borderRadius: '30px', maxHeight: 'none' }}>
                    {aiLoading ? (
                        ...
                        aiExplanation && !aiExplanation.isError ? (
                            <div style={{ display: 'flex', flexDirection: 'column', flex: 1, gap: '0px', justifyContent: 'center', border: '1px solid #747474', borderRadius: '22px', padding: '14px', backgroundColor: '#fff' }}>
    ...
    return (
        <div style={{ ...styles.viewport, backgroundColor: temas[idiomaEstudo].bg }}>
            <div style={styles.mobileContainer}>
                ...
                <div style={{ ...styles.cardFixoRelativo, flex: 1, backgroundColor: '#fff', padding: '15px', display: 'flex', flexDirection: 'column' }}>
