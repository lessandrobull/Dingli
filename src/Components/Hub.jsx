    ...
    <div style={{ ...styles.viewport, backgroundColor: temas[idiomaEstudo].bg }}>
      <div style={styles.mobileContainer}>
        ...
        <div className="scroll-container" style={styles.areaScrollMenu}>
          <button onClick={() => mudarTela('perfil')} style={{ ...styles.btnPadrao, backgroundColor: COR_BASE_CARDS, color: corFonteBotoes }}>
            {t.profile || 'Perfil'}
          </button>
          <button onClick={() => mudarTela('menuCartoes')} style={{ ...styles.btnPadrao, backgroundColor: COR_BASE_CARDS, color: corFonteBotoes }}>
            {t.phraseCards}
          </button>
