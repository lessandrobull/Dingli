import { COR_TOM_CLARO, COR_BASE_CARDS } from './themeColors';

export const tokens = {
  colors: { bgBase: COR_TOM_CLARO, bgCardLight: COR_TOM_CLARO, textMain: '#1e293b', textSec: '#64748b', textLight: '#fff', textMuted: '#94a3b8' },
...
export const styles = {
  ...
  quadroFrase: { backgroundColor: COR_TOM_CLARO, padding: tokens.spacing.sm, borderRadius: tokens.radii.lg, textAlign: 'center', margin: '0 0 10px 0', minHeight: '60px', display: 'flex', alignItems: 'center', justifyContent: 'center' },
  ...
  btnCursoMinimal: { padding: '16px', borderRadius: tokens.radii.md, border: 'none', fontWeight: '900', fontSize: '1.1rem', cursor: 'pointer' },
  ...
  btnLabHome: { backgroundColor: COR_TOM_CLARO, color: tokens.colors.textMain, padding: '15px', borderRadius: tokens.radii.md, border: 'none', margin: '0', display: 'flex', justifyContent: 'center', gap: '8px', alignItems: 'center' },
  ...
  btnNavTopo: { width: '100%', padding: '12px', borderRadius: '12px', fontWeight: 'bold', marginBottom: '5px', border: 'none', flexShrink: 0, minHeight: '48px', cursor: 'pointer' },
  cardFixoRelativo: { backgroundColor: COR_TOM_CLARO, borderRadius: '30px', padding: '20px', display: 'flex', flexDirection: 'column', boxSizing: 'border-box', margin: '0 auto 10px auto', boxShadow: '0 10px 25px rgba(0,0,0,0.2)', width: '100%', flex: 1, overflowY: 'auto', border: '4px solid transparent', transition: 'border-color 0.2s', minHeight: 0 },
  ...
  btnAcaoExtra: { flex: 1, padding: '12px 4px', borderRadius: '12px', border: 'none', fontWeight: 'bold', display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '0px', fontSize: '0.95rem', cursor: 'pointer', backgroundColor: COR_TOM_CLARO },
  controlesNavInferior: { display: 'flex', gap: '15px', marginTop: '5px' },
  btnNavFinal: { flex: 1, padding: '12px', borderRadius: '12px', border: 'none', fontWeight: 'bold', minHeight: '48px', cursor: 'pointer' },
