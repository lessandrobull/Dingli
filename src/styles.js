import { COR_BASE_CARDS, COR_BG_SECUNDARIOS } from './themeColors';

export const tokens = {
  colors: { bgBase: '#000', bgCardDark: '#111', bgCardLight: COR_BASE_CARDS, textMain: '#1e293b', textSec: '#64748b', textLight: '#fff', textMuted: '#94a3b8' },
...
export const styles = {
  ...
  cardFixoRelativo: { backgroundColor: COR_BASE_CARDS, borderRadius: '30px', padding: '20px', display: 'flex', flexDirection: 'column', boxSizing: 'border-box', margin: '0 auto 10px auto', boxShadow: '0 10px 25px rgba(0,0,0,0.2)', width: '100%', flex: 1, overflowY: 'auto', border: '4px solid transparent', transition: 'border-color 0.2s', minHeight: 0 },
  ...
  btnAcaoExtra: { flex: 1, padding: '12px 4px', borderRadius: '12px', border: 'none', fontWeight: 'bold', display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '0px', fontSize: '0.95rem', cursor: 'pointer', backgroundColor: COR_BG_SECUNDARIOS },
  btnAudioRound: { flex: 1, padding: '12px 4px', borderRadius: '12px', border: 'none', fontWeight: 'bold', backgroundColor: COR_BG_SECUNDARIOS, minHeight: '0px', fontSize: '0.95rem', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer' },
